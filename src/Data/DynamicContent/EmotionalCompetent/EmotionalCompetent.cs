...
{
  public class EmotionalCompetent : IDynamicContent
  {
    private readonly IOptions<Secrets.ConnectionStrings> _connStr;

    public EmotionalCompetent(IOptions<Secrets.ConnectionStrings> ConnectionStrings)
    {
    ...
    public Question.List List()
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          ...
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_EMOTIONAL_COMPETENT_LIST]";
    ...
    public BasicReturn Add(Question data)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_EMOTIONAL_COMPETENT_ADD]";
    ...
    public BasicReturn ChangeActive(Question data)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_EMOTIONAL_COMPETENT_ACTIVE]";
    ...
    public Question Question(string guid)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_EMOTIONAL_COMPETENT]";
    ...
    public BasicReturn Edit(Question data)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_EMOTIONAL_COMPETENT_EDIT]";
