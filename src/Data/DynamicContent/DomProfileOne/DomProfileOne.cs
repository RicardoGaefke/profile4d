...
{
  public class DomProfileOne : IDynamicContent
  {
    private readonly IOptions<Secrets.ConnectionStrings> _connStr;

    public DomProfileOne(IOptions<Secrets.ConnectionStrings> ConnectionStrings)
    {
    ...
    public Question.List List()
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          ...
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_DOM_PROFILE_ONE_LIST]";
    ...
    public BasicReturn Add(Question data)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_DOM_PROFILE_ONE_ADD]";
    ...
    public BasicReturn ChangeActive(Question data)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_DOM_PROFILE_ONE_ACTIVE]";
    ...
    public Question Question(string guid)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_DOM_PROFILE_ONE]";
    ...
    public BasicReturn Edit(Question data)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_DOM_PROFILE_ONE_EDIT]";
