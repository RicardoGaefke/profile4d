...
{
  public class BodyShape : IDynamicContent
  {
    private readonly IOptions<Secrets.ConnectionStrings> _connStr;

    public BodyShape(IOptions<Secrets.ConnectionStrings> ConnectionStrings)
    {
    ...
    public Question.List List()
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          ...
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_BODY_SHAPE_LIST]";
    ...
    public BasicReturn Add(Question data)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_BODY_SHAPE_ADD]";
    ...
    public BasicReturn ChangeActive(Question data)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_BODY_SHAPE_ACTIVE]";
    ...
    public BasicReturn Edit(Question data)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_BODY_SHAPE_EDIT]";
