...
{
  public class LimitedForcesTwo : IDynamicContent
  {
    private readonly IOptions<Secrets.ConnectionStrings> _connStr;

    public LimitedForcesTwo(IOptions<Secrets.ConnectionStrings> ConnectionStrings)
    {
    ...
    public Question.List List()
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          ...
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_LIMITED_FORCES_TWO_LIST]";
    ...
    public BasicReturn Add(Question data)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_LIMITED_FORCES_TWO_ADD]";
    ...
    public BasicReturn ChangeActive(Question data)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_LIMITED_FORCES_TWO_ACTIVE]";
    ...
    public Question Question(string guid)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_LIMITED_FORCES_TWO]";
    ...
    public BasicReturn Edit(Question data)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_LIMITED_FORCES_TWO_EDIT]";
