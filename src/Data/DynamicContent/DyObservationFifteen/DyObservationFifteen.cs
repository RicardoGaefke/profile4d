...
{
  public class DyObservationFifteen : IDynamicContent
  {
    private readonly IOptions<Secrets.ConnectionStrings> _connStr;

    public DyObservationFifteen(IOptions<Secrets.ConnectionStrings> ConnectionStrings)
    {
    ...
    public Question.List List()
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          ...
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_DY_OBSERVATION_FIFTEEN_LIST]";
    ...
    public BasicReturn Add(Question data)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_DY_OBSERVATION_FIFTEEN_ADD]";
    ...
    public BasicReturn ChangeActive(Question data)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_DY_OBSERVATION_FIFTEEN_ACTIVE]";
    ...
    public Question Question(string guid)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_DY_OBSERVATION_FIFTEEN]";
    ...
    public BasicReturn Edit(Question data)
    {
      ...
      using (SqlConnection Con = new SqlConnection(_connStr.Value.SqlServer))
      {
        using (SqlCommand Cmd = new SqlCommand())
        {
          Cmd.CommandType = CommandType.StoredProcedure;
          Cmd.Connection = Con;
          Cmd.CommandText = "[sp_DY_OBSERVATION_FIFTEEN_EDIT]";
