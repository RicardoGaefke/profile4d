...
const Chart4CanvasV2pdf = (props: Chart4CanvasProps): JSX.Element => {
  // eslint-disable-next-line no-unused-vars
  ...
  return (
    <>
      <canvas ref={refChart} style={{ display: 'none' }} width="100%" />
      <img
        alt="printing chart"
        ref={refImage}
...
Chart4CanvasV2pdf.displayName = 'Chart4CanvasV2pdf';

export default Chart4CanvasV2pdf;
