...
const Chart4CanvasV2 = (props: Chart4CanvasProps): JSX.Element => {
  ...
  const dataOriginal = [
    (primeiro.Name === 'Perfil Criativo' || segundo.Name === 'Perfil Criativo' || terceiro.Name === 'Perfil Criativo')
      ? (primeiro.Name === 'Perfil Criativo') ? ((primeiro.Total / 77) * 100).toFixed(2) : null
        || (segundo.Name === 'Perfil Criativo') ? ((segundo.Total / 77) * 100).toFixed(2) : null
          || (terceiro.Name === 'Perfil Criativo') ? ((terceiro.Total / 77) * 100).toFixed(2) : null
      : null,
    (primeiro.Name === 'Perfil Realizador' || segundo.Name === 'Perfil Realizador' || terceiro.Name === 'Perfil Realizador')
      ? (primeiro.Name === 'Perfil Realizador') ? ((primeiro.Total / 77) * 100).toFixed(2) : null
        || (segundo.Name === 'Perfil Realizador') ? ((segundo.Total / 77) * 100).toFixed(2) : null
          || (terceiro.Name === 'Perfil Realizador') ? ((terceiro.Total / 77) * 100).toFixed(2) : null
      : null,
    (primeiro.Name === 'Perfil Prestativo' || segundo.Name === 'Perfil Prestativo' || terceiro.Name === 'Perfil Prestativo')
      ? (primeiro.Name === 'Perfil Prestativo') ? ((primeiro.Total / 77) * 100).toFixed(2) : null
        || (segundo.Name === 'Perfil Prestativo') ? ((segundo.Total / 77) * 100).toFixed(2) : null
          || (terceiro.Name === 'Perfil Prestativo') ? ((terceiro.Total / 77) * 100).toFixed(2) : null
      : null,
    (primeiro.Name === 'Perfil Organizador' || segundo.Name === 'Perfil Organizador' || terceiro.Name === 'Perfil Organizador')
      ? (primeiro.Name === 'Perfil Organizador') ? ((primeiro.Total / 77) * 100).toFixed(2) : null
        || (segundo.Name === 'Perfil Organizador') ? ((segundo.Total / 77) * 100).toFixed(2) : null
          || (terceiro.Name === 'Perfil Organizador') ? ((terceiro.Total / 77) * 100).toFixed(2) : null
      : null,
    (primeiro.Name === 'Perfil Mediador' || segundo.Name === 'Perfil Mediador' || terceiro.Name === 'Perfil Mediador')
      ? (primeiro.Name === 'Perfil Mediador') ? ((primeiro.Total / 77) * 100).toFixed(2) : null
        || (segundo.Name === 'Perfil Mediador') ? ((segundo.Total / 77) * 100).toFixed(2) : null
          || (terceiro.Name === 'Perfil Mediador') ? ((terceiro.Total / 77) * 100).toFixed(2) : null
      : null,
    (primeiro.Name === 'Perfil Comandante' || segundo.Name === 'Perfil Comandante' || terceiro.Name === 'Perfil Comandante')
      ? (primeiro.Name === 'Perfil Comandante') ? ((primeiro.Total / 77) * 100).toFixed(2) : null
        || (segundo.Name === 'Perfil Comandante') ? ((segundo.Total / 77) * 100).toFixed(2) : null
          || (terceiro.Name === 'Perfil Comandante') ? ((terceiro.Total / 77) * 100).toFixed(2) : null
      : null,
    (primeiro.Name === 'Perfil Visionário' || segundo.Name === 'Perfil Visionário' || terceiro.Name === 'Perfil Visionário')
      ? (primeiro.Name === 'Perfil Visionário') ? ((primeiro.Total / 77) * 100).toFixed(2) : null
        || (segundo.Name === 'Perfil Visionário') ? ((segundo.Total / 77) * 100).toFixed(2) : null
          || (terceiro.Name === 'Perfil Visionário') ? ((terceiro.Total / 77) * 100).toFixed(2) : null
      : null,
    (primeiro.Name === 'Perfil Planejador' || segundo.Name === 'Perfil Planejador' || terceiro.Name === 'Perfil Planejador')
      ? (primeiro.Name === 'Perfil Planejador') ? ((primeiro.Total / 77) * 100).toFixed(2) : null
        || (segundo.Name === 'Perfil Planejador') ? ((segundo.Total / 77) * 100).toFixed(2) : null
          || (terceiro.Name === 'Perfil Planejador') ? ((terceiro.Total / 77) * 100).toFixed(2) : null
      : null,
    (primeiro.Name === 'Perfil Analítico' || segundo.Name === 'Perfil Analítico' || terceiro.Name === 'Perfil Analítico')
      ? (primeiro.Name === 'Perfil Analítico') ? ((primeiro.Total / 77) * 100).toFixed(2) : null
        || (segundo.Name === 'Perfil Analítico') ? ((segundo.Total / 77) * 100).toFixed(2) : null
          || (terceiro.Name === 'Perfil Analítico') ? ((terceiro.Total / 77) * 100).toFixed(2) : null
      : null,
  ];
  ...
  const data = {
    labels: [
      `${criativo.Name.replace('Perfil ', '')} ${((criativo.Total / 77) * 100).toFixed(2)}%`,
      `${realizador.Name.replace('Perfil ', '')} ${((realizador.Total / 77) * 100).toFixed(2)}%`,
      `${prestativo.Name.replace('Perfil ', '')} ${((prestativo.Total / 77) * 100).toFixed(2)}%`,
      `${organizador.Name.replace('Perfil ', '')} ${((organizador.Total / 77) * 100).toFixed(2)}%`,
      `${mediador.Name.replace('Perfil ', '')} ${((mediador.Total / 77) * 100).toFixed(2)}%`,
      `${comandante.Name.replace('Perfil ', '')} ${((comandante.Total / 77) * 100).toFixed(2)}%`,
      `${visionario.Name.replace('Perfil ', '')} ${((visionario.Total / 77) * 100).toFixed(2)}%`,
      `${planejador.Name.replace('Perfil ', '')} ${((planejador.Total / 77) * 100).toFixed(2)}%`,
      `${analitico.Name.replace('Perfil ', '')} ${((analitico.Total / 77) * 100).toFixed(2)}%`,
    ],
    datasets: [
      {
...
Chart4CanvasV2.displayName = 'Chart4CanvasV2';

export default Chart4CanvasV2;
