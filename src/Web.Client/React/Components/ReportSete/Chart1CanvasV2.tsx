...
const Chart1CanvasV2 = (props: Chart1CanvasProps): JSX.Element => {
  ...
  const amarelo = parseFloat(((comandante / 231) * 100).toFixed(2)) + parseFloat(((mediador / 231) * 100).toFixed(2)) + parseFloat(((organizador / 231) * 100).toFixed(2));

  // eslint-disable-next-line max-len
  const vermelho = parseFloat(((prestativo / 231) * 100).toFixed(2)) + parseFloat(((realizador / 231) * 100).toFixed(2)) + parseFloat(((criativo / 231) * 100).toFixed(2));

  // eslint-disable-next-line max-len
  const azul = parseFloat(((analitico / 231) * 100).toFixed(2)) + parseFloat(((planejador / 231) * 100).toFixed(2)) + parseFloat(((visionario / 231) * 100).toFixed(2));
