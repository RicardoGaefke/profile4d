...
import ReturnOrCreate from './ReturnOrCreate';

chai.use(chaiEnzyme());
Enzyme.configure({ adapter: new Adapter() });

describe('Web.Identity -> ForgotForm.ReturnOrCreate', (): void => {
  ...
  describe('Smoke Tests', (): void => {
    it('Should exist ReturnOrCreate', (): void => {
      const wrapper = shallow(<ReturnOrCreate />);
