...
import PDI from '../Introduction/Form/Form';
...
export const MyPDI = withFormik<WithTranslation & WithSnackbarProps & IProps, IStaticIntroduction>({
  ...
  handleSubmit: async (values, { setSubmitting, props }): Promise<void> => {
    ...
    await myAxios(window.location.href).post<IStaticIntroduction>('StaticContent/PDIEdit', {
