...
import TrinityBehavioralCompetent from '../Introduction/Form/Form';
...
export const MyTrinityBehavioralCompetent = withFormik<WithTranslation & WithSnackbarProps & IProps, IStaticIntroduction>({
  ...
  handleSubmit: async (values, { setSubmitting, props }): Promise<void> => {
    ...
    await myAxios(window.location.href).post<IStaticIntroduction>('StaticContent/TrinityBehavioralCompetentEdit', {
    ...
    return (
      <div className={classes.main}>
        <Typography
          ...
          variant="h5"
        >
          {t('StaticTrinityBehavioralCompetent:title')}
        </Typography>
