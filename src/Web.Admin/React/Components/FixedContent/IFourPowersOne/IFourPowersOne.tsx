...
import IFourPowersOne from '../FirstPage/Form/Form';
...
export const MyIFourPowersOne = withFormik<WithTranslation & WithSnackbarProps & IProps, IStaticFirstPage>({
  ...
  handleSubmit: async (values, { setSubmitting, props }): Promise<void> => {
    ...
    await myAxios(window.location.href).post<IStaticFirstPage>('StaticContent/IntFourPowersOneEdit', {
      ...
      if (data.Success) {
        enqueueSnackbar(t('StaticIFourPowersOne:feedback.success'), {
          variant: 'success',
        });
      } else {
        enqueueSnackbar(t('StaticIFourPowersOne:feedback.failure'), {
          variant: 'error',
        });
      }
    }).catch((): void => {
...
export const Login = withTranslation()(withSnackbar(MyIFourPowersOne));
