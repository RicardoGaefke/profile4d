...
import TrinityBehavioralSabotage from '../Introduction/Form/Form';
...
export const MyTrinityBehavioralSabotage = withFormik<WithTranslation & WithSnackbarProps & IProps, IStaticIntroduction>({
  ...
  handleSubmit: async (values, { setSubmitting, props }): Promise<void> => {
    ...
    await myAxios(window.location.href).post<IStaticIntroduction>('StaticContent/TrinityBehavioralSabotageEdit', {
    ...
    return (
      <div className={classes.main}>
        <Typography
          ...
          variant="h5"
        >
          {t('StaticTrinityBehavioralSabotage:title')}
        </Typography>
