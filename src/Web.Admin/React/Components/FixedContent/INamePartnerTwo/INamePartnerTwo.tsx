...
import INamePartnerTwo from '../FirstPage/Form/Form';
...
const MyINamePartnerTwo = withFormik<WithTranslation & WithSnackbarProps & IProps, IStaticFirstPage>({
  ...
  handleSubmit: async (values, { setSubmitting, props }): Promise<void> => {
    ...
    await myAxios(window.location.href).post<IStaticFirstPage>('StaticContent/IntNamePartnerTwoEdit', {
      ...
      if (data.Success) {
        enqueueSnackbar(t('StaticINamePartnerTwo:feedback.success'), {
          variant: 'success',
        });
      } else {
        enqueueSnackbar(t('StaticINamePartnerTwo:feedback.failure'), {
          variant: 'error',
        });
      }
    }).catch((): void => {
...
export const Login = withTranslation()(withSnackbar(MyINamePartnerTwo));
