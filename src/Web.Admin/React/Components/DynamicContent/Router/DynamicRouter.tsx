...
import QuestionsSelected from '../QuestionsSelected/Questions';
import QuestionsSelectedAdd from '../QuestionsSelected/Add/Add';
import QuestionsSelectedEdit from '../QuestionsSelected/Edit/Page';
  ...
  (props: RouteComponentProps): React.ReactElement<RouteComponentProps> => {
    ...
    return (
      <MyTemplate>
        ...
        <Route path={`${match.url}/questionsSelected`} exact component={QuestionsSelected} />
        <Route path={`${match.url}/questionsSelected/add`} component={QuestionsSelectedAdd} />
        <Route path={`${match.url}/questionsSelected/edit/:id`} component={QuestionsSelectedEdit} />
