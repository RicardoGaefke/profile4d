...
const MyQuestion = withFormik<WithTranslation & WithSnackbarProps & RouteComponentProps & IProps, IDynamicContent>({
  displayName: 'Dynamic Content Add Question Categorized',
  ...
  handleSubmit: async (values, { setSubmitting, props }): Promise<void> => {
    ...
    await myAxios(window.location.href).post<IDynamicContent>('QuestionsSelected/Add', {
      ...
      if (data.Success) {
        ...
        history.push('/dynamicContent/questionsSelected');
      } else {
