...
export default {
  ...
  twelvecompetencesapresentation: 'Presentation of the 12 Competencies',
  fourcompetentstages: 'The 4 stages of competence',
  observation: 'Observation',
  twelvecompetences: 'The Twelve Skills',
  excellentcompromise: 'Commitment to excellence',
  ...
  peoplesdevolopment: 'Developing people',
  ...
  internalparnerone: 'Internal Partner Name (1)',
  internalpartnertwo: 'Internal Partner Name (2)',
  nameidealpartner: 'Ideal partner name',
  behavioralresources: 'Behavioral Profile Resource',
  twelvecompetencestable: 'Table of 12 competencies',
} as ILanguage;
