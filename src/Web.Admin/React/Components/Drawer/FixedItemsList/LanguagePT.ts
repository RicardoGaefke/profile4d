...
export default {
  ...
  fourcompetentstages: 'Os 4 estágios da competência',
  observation: 'Observação',
  twelvecompetences: 'As 12 Competências',
  ...
  internalparnerone: 'Nome do Parceiro interno (1)',
  internalpartnertwo: 'Nome do Parceiro interno (2)',
  nameidealpartner: 'Nome do parceiro ideal',
  behavioralresources: 'Recurso do Perfil Comportamental',
  twelvecompetencestable: 'Tabela das 12 competências',
} as ILanguage;
