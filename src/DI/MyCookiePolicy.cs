...
public class CustomCookieAuthenticationEvents : CookieAuthenticationEvents
{
  ...
  public override Task RedirectToAccessDenied(RedirectContext<CookieAuthenticationOptions> context)
  {
    ...
    string _identity = "https://identity.hextriade.com/403";
    ...
    {
      _identity = "https://identity.staging.hextriade.com/403";
    }
  ...
  {
    string _host = context.Request.Host.ToString();
    string _identity = "identity.hextriade.com";
    ...
    if (_host.Contains("staging"))
    {
      _identity = "identity.staging.hextriade.com";
    }
